            ...
            <tr>
                ...
                <td>
                    <div class="btn-group btn-group-sm ">
                        <a href="<?php echo ROOT . 'permisoRol/editar/' . $permisoRol->getId(); ?>" class="btn btn-default"><i class="fa fa-lg fa-edit"></i></a> 
                        <a href="<?php echo ROOT . 'permisoRol/mostrar/' . $permisoRol->getId(); ?>"class="btn btn-primary"><i class="fa fa-lg fa-eye"></i></a>
