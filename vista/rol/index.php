            ...
            <tr>
                ...
                <td>
                    <div class="btn-group btn-group-sm ">
                        <a href="<?php echo ROOT . 'rol/editar/' . $permisoRol->getId(); ?>" class="btn btn-default"><i class="glyphicon glyphicon-edit"></i></a> 
                        <a href="<?php echo ROOT . 'rol/mostrar/' . $permisoRol->getId(); ?>"class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"></i></a>
                        <a href="javascript:;" class="btn btn-danger"
                           ...
                           <a href='<?php echo ROOT . "rol/eliminar/" . $permisoRol->getId(); ?>' 
