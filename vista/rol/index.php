...
<table class="table table-hover table-striped">
    ...
    <tbody>
        <?php foreach ($this->listaRoles as $key => $permiso): ?>
            <tr>
                <td><?php echo $permiso->getNombre(); ?></td>
                <td>
                    <div class="btn-group btn-group-sm ">
                        <a href="<?php echo ROOT . 'rol/editar/' . $permiso->getId(); ?>" class="btn btn-default"><i class="glyphicon glyphicon-edit"></i></a> 
                        <a href="<?php echo ROOT . 'rol/mostrar/' . $permiso->getId(); ?>"class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"></i></a>
                        <a href="javascript:;" class="btn btn-danger"
                           ...
                           <a href='<?php echo ROOT . "rol/eliminar/" . $permiso->getId(); ?>' 
